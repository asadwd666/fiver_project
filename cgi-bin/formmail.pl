...
@referers = ('condosites.net', 'www.condosites.net', 'prototype.condosites.net', 'condosites.net');
...
sub return_html {
    ...
    # Otherwise, begin printing the response page.                           #
        ...
        else { print "<h1>Please print a copy for your records.</h1>\n" }
        ...
        <center><font size=-1>Print this page as your receipt.</font></center>
        </body>
       </html>
(END HTML FOOTER)
    }
...
sub send_mail {
    ...
    print MAIL "From: donotreply@condosites.net\n";
   ...
   <table border=0 width=600>
    <tr><td>The form attempting to use
     ...
     Add <tt>'$host'</tt> to your <tt><b>\@referers</b></tt> array.<hr size=1>
        <center><font size=-1>If you are seeing this message, please send a copy of this text to the webmaster.</font></center>
    </td></tr>
   </table>
  </center>
 </body>
