<?php
    ...
    $dataArray = array();
    $queryNEWS  = "SELECT *, UNIX_TIMESTAMP(CONCAT(pod)) as result_index FROM chalkboard WHERE (realtor = 'Y' AND eod >= CURRENT_DATE() AND pod <= CURRENT_DATE()) AND (`flag` = 'U' OR `flag` = 'M' OR `flag` = 'A' OR `flag` = 'I' OR `flag` = 'D' OR `flag` = 'C' OR `flag` = 'R') ORDER BY pod DESC";
...
<!-- CALENDAR -->
	...
	<?php
		...
		{
	?>
	<li><a href="../modules/events-single.php?choice=<?php echo "{$rowCID['int1']}"; ?>" class="iframe-link"><i class="fa fa-calendar-o" aria-hidden="true"></i></a>
...
<?php if ($row['pic'] == '' AND ($row['pic2'] != '' AND $row['pic3'] != '')){ ?>
	...
	<?php
		...
		{
	?>
            <div class="newsboard-post-image-twins-1"><a href="../download-documents-mini.php?id=<?php echo "{$rowPic2['id']}"; ?>&docdate=<?php echo "{$rowPic2['docdate']}"; ?>&size=<?php echo "{$rowPic2['size']}"; ?>" class="iframe-link" ><img src="../download-documents-mini.php?id=<?php echo "{$rowPic2['id']}"; ?>&docdate=<?php echo "{$rowPic2['docdate']}"; ?>&size=<?php echo "{$rowPic2['size']}"; ?>" alt="<?php echo "{$rowPic2['title']}"; ?>" title="<?php echo "{$rowPic2['title']}"; ?>"></a></div>
	<?php
		}
	?>
      </div>
	...
	<?php
		...
		{
	?>
            <div class="newsboard-post-image-twins-2"><a href="../download-documents-mini.php?id=<?php echo "{$rowPic3['id']}"; ?>&docdate=<?php echo "{$rowPic3['docdate']}"; ?>&size=<?php echo "{$rowPic3['size']}"; ?>" class="iframe-link" ><img src="../download-documents-mini.php?id=<?php echo "{$rowPic3['id']}"; ?>&docdate=<?php echo "{$rowPic3['docdate']}"; ?>&size=<?php echo "{$rowPic3['size']}"; ?>" alt="<?php echo "{$rowPic3['title']}"; ?>" title="<?php echo "{$rowPic3['title']}"; ?>"></a></div>
	<?php
		}
	?>
      </div>
