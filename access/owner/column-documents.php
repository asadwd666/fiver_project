...
$query  = "SELECT `id` FROM documents WHERE doctype = 'Documents' AND owner = 'Y' AND aod NOT BETWEEN '0000-01-01' AND CURRENT_DATE()";
...
if (!$tabFound) {
    $query  = "SELECT `int1` FROM tabs WHERE tabname = 'Documents' AND owner = 'Y' ORDER BY title";
    $result = mysqli_query($conn, $query);
    $row = $result->fetch_array(MYSQLI_ASSOC);
...
if (!$tabFound) {
    $query  = "SELECT * FROM folders WHERE tabname = 'Documents' AND owner = 'Y' ORDER BY title";
    $result = mysqli_query($conn, $query);
    $row = $result->fetch_array(MYSQLI_ASSOC);
...
<?php
	...
	$query  = "SELECT `id`, type, title, aod, docdate, size FROM documents WHERE doctype = 'Documents' AND owner = 'Y' AND aod NOT BETWEEN '0000-01-01' AND CURRENT_DATE() ORDER BY title";
...
<!-- Links -->
<?php
	$query  = "SELECT `int1`, tabname, title, rednote, image, url, window FROM tabs WHERE tabname = 'Documents' AND owner = 'Y' ORDER BY title";
