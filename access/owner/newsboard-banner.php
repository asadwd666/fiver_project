...
<?php
    ...
    $queryMB  = "SELECT owner FROM meetingbox WHERE owner = 'N'";
...
<?php
	$queryMB  = "SELECT * FROM meetingbox WHERE owner = 'Y'";
	$resultMB = mysqli_query($headingConn,$queryMB);
...
<?php if ($rowMB['url'] !== ''){ ?>
		<li>
			<a href="<?php echo "{$rowMB['url']}"; ?>" target="_blank" onclick="javascript:pageTracker._trackPageview('URL/<?php echo "{$rowMB['url']}"; ?>'); ">Link to Website</a>
		</li>
<?php }; ?>
