...
<?php
	$query  = "SELECT title FROM tabs WHERE `int1` = '451'";
...
<!-- TEXT 1 -->
<?php
	$query  = "SELECT text1 FROM forms WHERE `int1` = '451'";
	$result = mysqli_query($conn, $query);
...
<?php
	$query  = "SELECT terms FROM forms WHERE `int1` = '451' AND terms != ''";
	$result = mysqli_query($conn, $query);
...
<?php
	$type    = $_GET['choice'];
	$query  = "SELECT text2 FROM forms WHERE `int1` = '451'";
	$result = mysqli_query($conn, $query);
