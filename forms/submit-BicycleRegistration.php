...
if ($action != null){
	...
	if ($action == "add"){
		...
		if($color != "" && $model != "" && $make != ""){
			...
			$subject = "$CommunityName/CondoSites - Bicycle Registration";
		    
		    $body = "<!DOCTYPE HTML><html><body><div style='padding: 25px;'>";
            $body .= "<p>A website user has submitted a bicycle for registration through the ".$CommunityName."/CondoSites community website.  Your action is required.<br>To approve and edit this listing, access the Vehicles control panel.<br><br>Below is an overview of the information submitted by the user.<br><br>Make: ".$make."<br>Model: ".$model."<br>Color: ".$color."<br>State: ".$state."<br>License Plate: ".$license."<br>Space: ".$space."<br><br>Submitted by: ".$first_name." ".$last_name."<br>Email: ".$useremail."<br>User ID: ".$userid."<br>User IP Address: ".$useripaddress."</p>";
...
<?php
	$query  = "SELECT title FROM tabs WHERE `int1` = '455'";
...
<!-- TEXT 1 -->
<?php
	$query  = "SELECT text1 FROM forms WHERE `int1` = '455'";
	$result = mysqli_query($conn, $query);
...
<!-- FIELDS -->
      ...
      <div class="row medium-collapse">
        <div class="small-12 medium-5 large-4 columns"><label for="make" class="middle note-anchor">Bicycle Make</label></div>
        <div class="small-12 medium-5 end columns"><input name="make" type="text" size="20" maxlength="30" class="form" value="<?php echo($_POST['make']); ?>"><input type="hidden" name="model" class="form" value="B*"></div>
      </div>
      <div class="row medium-collapse">
        <div class="small-12 medium-5 large-4 columns"><label for="color" class="middle note-anchor">Bicycle Color</label></div>
...
<option value="Pink" <?php if($_POST['color'] == "Pink"){ echo("SELECTED"); } ?>>Pink</option>
...
<option value="Violet" <?php if($_POST['color'] == "Violet"){ echo("SELECTED"); } ?>>Violet</option>
      ...
      <div class="row medium-collapse">
        <div class="small-12 medium-5 large-4 columns"><label for="space" class="middle note-anchor">Space<br><span class="note-red">If applicable</span></label></div>
      ...
      <div class="row medium-collapse">
        <div class="small-12 medium-5 large-4 columns"><label for="license" class="middle note-anchor">Registration Number<br><span class="note-red">If applicable</span></label></div>
      ...
      <div class="row medium-collapse">
        <div class="small-12 medium-5 large-4 columns"><label for="state" class="middle note-anchor">State<br><span class="note-red">If applicable</span></label></div>
        <div class="small-12 medium-5 end columns">
      	<select name="state">
...
<?php
	$query  = "SELECT terms FROM forms WHERE `int1` = '455' AND terms != ''";
	$result = mysqli_query($conn, $query);
...
<?php
	$type    = $_GET['choice'];
	$query  = "SELECT text2 FROM forms WHERE `int1` = '455'";
	$result = mysqli_query($conn, $query);
