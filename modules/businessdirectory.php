...
<div id="all-documents-folder" class="stand-alone-page">
  <div class="popup-header">
    <h4>
<?php
	$query  = "SELECT title FROM tabs WHERE `int1` = '300'";
...
<!-- Mobile Filter Notice -->
  <div class="stand-alone-page-content">
    <div class="rotate-note">Rotate your device to view comments and to filter listings by category.</div>
  </div>
...
<!-- END SUBMIT CONTENT -->
    ...
    <tr>
      ...
      <th align="left" class="table-sortable:alphanumeric table-filterable" style="cursor:pointer;"><small>Category</small></th>
    </tr>
  </thead>
  <tfoot>
...
<!-- DATABASE RESULTS -->
<?php
	$query  = "SELECT * FROM concierge WHERE approved = 'Y' ORDER BY name";
	$result = mysqli_query($dbConn, $query);
