<?php $current_page = '16'; include('protect.php'); $id = $_POST["id"]; $action = $_POST["action"];
...
<div class="nav-section-header-cp">
        <strong>Edit a Utility or Local Link</strong>
</div>
<?php
...
<form enctype="multipart/form-data" method="POST" action="utilities-edit.php">
...
<option value="Utility" <?php if($row['category'] == "Utility"){ echo("SELECTED"); } ?>>Utility</option>
<option value="Local Links" <?php if($row['category'] == "Local Links"){ echo("SELECTED"); } ?>>Local Link</option>
</select>
            </div>
        </div>
        <div class="row medium-collapse" style="padding-left: 30px;">
            <div class="small-12 medium-5 columns"><label for="email" class="middle">Label</label></div>
            <div class="small-12 medium-7 end columns"><input name="utility" size="30" maxlength="100" class="form" placeholder="Phone Company" type="text" value="<?php echo "{$row['utility']}"; ?>" required></div>
        </div>
        <div class="row" style="padding: 10px 10px 10px 0px;">
...
<form action="utilities.php" method="get">
...
<div class="small-12 medium-12 large-12 columns note-black"><br><br>Utilities and Local Links Edit Control Panel Page<br></div>
</body>
</html>
