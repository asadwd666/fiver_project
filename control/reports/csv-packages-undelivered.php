...

{
	...
	$query  = "SELECT * FROM packages WHERE pickedup = '0000-00-00 00:00:00' LIMIT 1";

	$result = mysqli_query($conn,$query) or die('Error, query failed');
	list($int1, $recipient, $userid, $packagetype, $pkgtracking, $from, $pkglocation, $received, $recemp, $pickedup, $puemp, $pickedupby, $lastedited, $created, $comments) = $result->fetch_array();

header("Content-Type: text/csv");
header("Content-Disposition: attachment; filename=Packages-Undelivered.csv");
}
?>
