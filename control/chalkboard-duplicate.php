<?php $current_page = '9'; include('protect.php'); $int1 = $_POST["int1"]; $action = $_POST["action"]; if ($action == "save"){
...
<div class="nav-section-header-cp">
        <strong>Copy a Newsboard Article</strong>
</div>
...
<form enctype="multipart/form-data" method="POST" action="chalkboard-duplicate.php">
        ...
        <div class="row medium-collapse" style="padding-left: 30px;">
            <div class="small-12 medium-12 end columns" style="padding-bottom: 10px;">
                <label for="file" class="middle" style="margin-bottom: -5px;">Main body of your Newsboard Article...
...
<?php include('calid-field-edit.php'); ?>
        ...
        <div class="row medium-collapse">
            <div class="small-6 columns" align="center">
	            ...
	            <input name="submit" value="Save Copy" class="submit" type="submit">
            </div>
</form>
