...
<div align="center">
    <p><b>Showing:</b> DID Packages &nbsp; &nbsp; <b>Switch to: </b><a href="videodisplay-vertical.php">DID Portrait</a> | <a href="videodisplay.php">DID Classic</a></p>
</div>

<div align="center" class="show-for-large">
    <style>
        #wrap-large { width: 980px; height: 560px; padding: 0; overflow: hidden; }
        #frame-large {
            width: 1920px;
            height: 1093px;
            -ms-zoom: 0.5;
    ...
    <div id="wrap-large" class="display-bezel-large">
        <iframe id="frame-large" src="../display-packages/index.php" type="text/html" width="100%" height="1080px;"></iframe>
    </div>
</div>

<div align="center" class="show-for-medium-only">
    <style>
        #wrap-medium { width: 686px; height: 392px; padding: 0; overflow: hidden; }
        #frame-medium {
            width: 1920px;
            height: 1093px;
            -ms-zoom: 0.35;
    ...
    <div id="wrap-medium" class="display-bezel-medium">
        <iframe id="frame-medium" src="../display-packages/index.php" type="text/html" width="100%" height="1080px;"></iframe>
    </div>
</div>

<div align="center" class="show-for-small-only">
    <style>
        #wrap-small { width: 356px; height: 205px; padding: 0; overflow: hidden; }
        #frame-small {
            width: 1920px;
            height: 1093px;
            -ms-zoom: 0.18;
    ...
    <div id="wrap-small" class="display-bezel-small">
        <iframe id="frame-small" src="../display-packages/index.php" type="text/html" width="100%" height="1080px;"></iframe>
    </div>
</div>
